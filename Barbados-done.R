...
#Barbados in America
source("controls_w.R")
barbados <- controls(dem, ep_study, c="BRB")
barbados_ <- data.frame(Reduce(rbind, barbados))
barbados_ <- barbados_[!(is.na(barbados_$country_text_id)),]
barbados_c <- unique(barbados_$country_name)
barbados_in <- barbados_[barbados_$Continent_Name=="North America" & barbados_$Continent_Name=="South America",]
barbados_in <- barbados_in[!(is.na(barbados_in$country_text_id)),]
barbados_in_c <- unique(barbados_in$country_name)
barbados_in_c <- c(barbados_in_c, "Barbados")
barbados_c <- c(barbados_c, "Barbados")


#####IN America - not possible- no control America ####
#db <- db1[which(db1$country %in% malta_in_c),]
#db <- db[db$year>1951 & db$year<1973,]

db <- db2[which(db2$country %in% barbados_in_c),]
db <- db[db$year>1947 & db$year<1968,]
...
dbw <- db1[which(db1$country %in% barbados_c),]
dbw <- dbw[dbw$year>1949 & dbw$year<1968,]
table <- as.data.frame(table(dbw$codenum))
table <- table[table$Freq==18,]
table$Var1 <- as.factor(table$Var1)
c <- as.vector(table$Var1)
...
dataprep.outw <- dataprep(
  ...
  time.predictors.prior = 1951:1957 ,
  special.predictors = list(
    list("averagegdppc", seq(1950, 1955,5), "mean"),
    list("primary_barro", seq(1950, 1955,5), "mean"),
    #list("secondary_barro", seq(1950, 1955,5), "mean"),
    #list("trade", seq(1950,1957), "mean"),
    list("ggdp", 1953:1957, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c( 2, 3, 15, 23,
                          30, 41, 43, 54, 
                          66, 74,
                          85, 87, 90, 94, 95, 101, 
                          122, 
                          125, 137, 140, 143,
                          154),
  time.optimize.ssr = 1951:1962,
  time.plot = 1951:1967)

# InspeÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o das matrizes X1 e Z1, ou seja, da matriz das caracterÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ?sitcas da observaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o tratada e da 
# matriz das observaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂµes da variÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡vel de resultado da tratada no perÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ?odo prÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©-tratamento, repectivamente.
dataprep.outw$X1
dataprep.outw$Z1

# Correr a funÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o synth() (que optimiza a funÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o de perda encadeada para os pesos W e V)
synth.outw <- synth(dataprep.outw)

# ExtraÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o dos resultados da optimizaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o feita pela funÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o synth(). ReplicaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o parcial da Tabela 3.
synth.tablesw <- synth.tab(dataprep.res = dataprep.outw, synth.res = synth.outw)
synth.tablesw$tab.w
synth.tablesw$tab.pred

# ReplicaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£o da Figura 1
Y1w  <- dataprep.outw$Y1
Y1synthw <- dataprep.outw$Y0 %*% synth.outw$solution.w
plot(1951:1967, Y1w, ylim=c(-0,10), type="l", xlab = "Year", ylab = "Finland GDP per capita growth rate")
lines(1951:1967, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(0, 10), Legend = c("Barbados",
                                       "Synthetic Barbados"), Legend.position = "topleft")
abline(v=c(1957), col=c("black"), lwd=c(2))
dev.off()
...
plot( 1951:1967, Y1placw, ylim=c(-2,8), type="l", xlab = "Year", ylab = "Italy GDP per capita growth rate")
lines( 1951:1967, Y1synthplacw, type="l", lty=2)


png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(0, 7), Legend = c("Albania",
...
plot(1951:1967, Y12w, ylim=c(-10,20), type="l", xlab = "Year", ylab = "PTR GDP per capita growth rate")
lines(1951:1967, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10, 20), Legend = c("Mauritius",
                                        "Synthetic Mauritius"), Legend.position = "topleft")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_ALL.png")
plot(1951:1967, Y1w, ylim=c(-10,20), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1951:1967, Y1placw, type="l", lty=2, col="blue")
lines(1951:1967, Y12w, type="l", lty=2, col="blue4")
abline(v=c(1957), col=c("black"), lwd=c(2))
legend("topleft", legend = c("Barbados", "Albania", "Mauritius"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_DEN_10Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.4), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
legend("topleft", legend = c("Barbados", "Albania ", "Mauritius " ),
       col = c("red", "blue", "green", "pink"), lty = c(1,2,2,2), cex = 0.8)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.4), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
legend("topleft", legend = c("Barbados", "Albania ", "Mauritius " ),
       col = c("red", "blue", "green", "pink"), lty = c(1,2,2,2), cex = 0.8)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.30), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRB_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.30), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Barbados", "Albania ", "Mauritius " ),
