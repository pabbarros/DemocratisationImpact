...
#Bolivia
source("controls_w.R")
bolivia <- controls(dem, ep_study, c="BOL")
bolivia_ <- data.frame(Reduce(rbind, bolivia))
bolivia_ <- bolivia_[!(is.na(bolivia_$country_text_id)),]
bolivia_c <- unique(bolivia_$country_name)
bolivia_in <- bolivia_[bolivia_$Continent_Name=="North America" | bolivia_$Continent_Name=="South America" ,]
bolivia_in <- bolivia_in[!(is.na(bolivia_in$country_text_id)),]
bolivia_in_c <- unique(bolivia_in$country_name)
bolivia_in_c <- c(bolivia_in_c, "Bolivia")
bolivia_c <- c(bolivia_c, "Bolivia")

#####IN AMERICA ####
db <- db1[which(db1$country %in% bolivia_in_c),]
db <- db[db$year>1971 & db$year<1993,]
...
dataprep.out <- dataprep(
  foo = db,
  predictors = c("child_mort", "popg", "trade", "gcff", "secondary") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1972:1982,
  special.predictors = list(
    list("averagegdppc", seq(1975, 1982,5), "mean"),
    list("primary_barro", seq(1975, 1982,5), "mean"),
    list("ggdp", 1979:1982, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(35, 44, 56, 91, 110),
  time.optimize.ssr = 1972:1982,
  time.plot = 1972:1992)
...
plot(1972:1992, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Bolivia Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7,6), Legend = c("Bolivia",
                                       "Synthetic Bolivia"), Legend.position = "bottomleft")
abline(v=c(1982), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  controls.identifier = c(35, 56, 91, 110),
  time.optimize.ssr = 1972:1982,
  time.plot = 1972:1992)
...
plot(1972:1992, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-11,10), Legend = c("El Salvador",
                                       "Synthetic El Salvador"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(35, 44, 91, 110),
  time.optimize.ssr = 1972:1982,
  time.plot = 1972:1992)
...
plot(1972:1992, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Bolivia Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6,7), Legend = c("Guatemala",
                                       "Synthetic Guatemala"), Legend.position = "topright")
dev.off()
...
dataprep.out.plac3 <- dataprep(
  ...
  controls.identifier = c(44, 56, 91, 110),
  time.optimize.ssr = 1972:1982,
  time.plot = 1972:1992)
...
plot(1972:1992, Y1.plac3 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Bolivia Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth.plac3, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-16,8), Legend = c("Cuba",
                                       "Synthetic Cuba"), Legend.position = "bottomleft")
dev.off()

##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_IN_ALL.png")
plot(1972:1992, Y1, ylim=c(-16,8), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1972:1992, Y1.plac, type="l", lty=2, col="blue")
lines(1972:1992, Y1.plac2, type="l", lty=2, col="blue4")
lines(1972:1992, Y1.plac3, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("Bolivia", "El Salvador", "Guatemala", 'Cuba'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BOL_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.18), lwd=c(2))
...
legend("topleft", legend = c("Bolivia", "El Salvador", 'Guatemala','Cuba'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BOL_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.18), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BOL_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BOL_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BOL_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.13), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% bolivia_c),]
dbw <- dbw[dbw$year>1971 & dbw$year<1993,]
...
dataprep.outw <- dataprep(
  ...
  special.predictors = list(
    ...
    list("primary_barro", seq(1975, 1980,5), "mean"),
    list("ggdp", 1979:1982, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  ...
  time.variable = "year",
  treatment.identifier = 16,
  controls.identifier = c(3, 56, 24, 30, 35, 
                          44, 54, 65, 
                          74, 85, 86, 87, 91, 94, 
                          101, 110, 126, 
                          139, 142, 145, 156),
...
plot(1972:1992, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1972:1992, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10, 7), Legend = c("Bolivia",
                                        "Synthetic Bolivia"), Legend.position = "bottomright")
abline(v=c(1982), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 44,
  controls.identifier = c(3, 24, 30, 35, 
                          56, 54, 65, 
                          74, 85, 86, 87, 91, 94, 
                          101, 110, 126, 
                          139, 142, 145, 156),
...
plot(1972:1992, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1972:1992, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-12,8), Legend = c("Cuba",
...
dataprep.out.plac2w <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 56,
  controls.identifier = c(3, 16, 24, 30, 35, 
                          54, 65, 
                          74, 85, 86, 87, 91, 94, 
                          101, 110, 126, 
                          139, 142, 145, 156),
...
plot(1972:1992, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7, 6), Legend = c("Ghana",
                                        "Synthetic Ghana"), Legend.position = "bottomleftt")
dev.off()
...
plot(1972:1992, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1972:1992, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5, 10), Legend = c("Sierra Leone",
                                        "Synthetic Sierra Leone"), Legend.position = "bottomright")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_ALL.png")
plot(1972:1992, Y1w, ylim=c(-25,25), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1972:1992, Y1placw, type="l", lty=2, col="blue")
lines(1972:1992, Y12w, type="l", lty=2, col="blue4")
lines(1972:1992, Y13w, type="l", lty=2, col="blue3")
#lines(1972:1992, Y14w, type="l", lty=2, col="blue2")
legend("bottomleft", legend = c("Bolivia", "Cuba", "Ghana", "Sierra Leone"),
       col = c("red", "blue", "blue4", "blue3"), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(1982), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Bolivia", "Cuba", "Ghana", 'Sierra Leone'),
       col = c("red", "blue", "green", 'pink'), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BOL_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.13), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
