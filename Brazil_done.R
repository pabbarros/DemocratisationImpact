...
#Brazil
source("controls_w.R")
brazil <- controls(dem, ep_study, c="BRA")
brazil_ <- data.frame(Reduce(rbind, brazil))
brazil_ <- brazil_[!(is.na(brazil_$country_text_id)),]
brazil_c <- unique(brazil_$country_name)
brazil_in <- brazil_[brazil_$Continent_Name=="North America" | brazil_$Continent_Name=="South America" ,]
brazil_in <- brazil_in[!(is.na(brazil_in$country_text_id)),]
brazil_in_c <- unique(brazil_in$country_name)
brazil_in_c <- c(brazil_in_c, "Brazil")
brazil_c <- c(brazil_c, "Brazil")

#####IN AMERICA ####
db <- db1[which(db1$country %in% brazil_in_c),]
db <- db[db$year>1972 & db$year<1994,]
...
plot(1973:1993, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Brazil Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7,12), Legend = c("Brazil",
                                     "Synthetic Brazil"), Legend.position = "topright")
abline(v=c(1983), col=c("black"), lwd=c(2))
dev.off()
...
plot(1973:1993, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7,7), Legend = c("Guatemala",
                                       "Synthetic Guatemala"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(35, 44, 56, 110),
  time.optimize.ssr = 1973:1993,
  time.plot = 1973:1993)
...
plot(1973:1993, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Brazil Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6,8), Legend = c("Mexico",
                                       "Synthetic Mexico"), Legend.position = "topright")
dev.off()


##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_IN_ALL.png")
plot(1973:1993, Y1, ylim=c(-7,11), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1973:1993, Y1.plac, type="l", lty=2, col="blue")
lines(1973:1993, Y1.plac2, type="l", lty=2, col="blue4")
legend("topright", legend = c("Brazil", "Guatemala", "Mexico"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRA_IN_DEN_10Y.png")
...
legend("topleft", legend = c("Brazil", "Guatemala", 'Mexico'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRA_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.14), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRA_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.13), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRA_IN_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/BRA_IN_DEN_2Y.png")
...
#lines(density(norm_datap4), col='orange', lty=2)
legend("topleft", legend = c("Brazil", "Guatemala", 'Mexico'),
       col = c("red", "blue", 'green'), 'green', lty = c(1,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% brazil_c),]
dbw <- dbw[dbw$year>1972 & dbw$year<1994,]
...
plot(1973:1993, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Brazil Real GDP per capita Growth Rate")
lines(1973:1993, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA.png")
...
plot(1973:1993, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1973:1993, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,10), Legend = c("Morocco",
                                       "Synthetic Morocco"), Legend.position = "topright")
dev.off()
...
dataprep.out.plac2w <- dataprep(
  ...
  controls.identifier = c(24, 30, 35,
                          44, 54, 56, 65,
                          74, 85, 86, 91, 94, 101, 
                          110,
                          139, 142, 145, 156),
...
plot(1973:1993, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5, 10), Legend = c("Algeria",
                                        "Synthetic Algeria"), Legend.position = "topright")
dev.off()
...
plot(1973:1993, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7, 8), Legend = c("Mexico",
                                        "Synthetic Mexico"), Legend.position = "topright")
dev.off()
...
plot(1973:1993, Y14w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1973:1993, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_PLC4.png")
path.plot(synth.res = synth.out.plac4w, dataprep.res = dataprep.out.plac4w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15, 8), Legend = c("Ghana",
                                        "Synthetic Ghana"), Legend.position = "bottomright")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_ALL.png")
plot(1973:1993, Y1w, ylim=c(-15,13), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1973:1993, Y1placw, type="l", lty=2, col="blue")
lines(1973:1993, Y12w, type="l", lty=2, col="blue4")
lines(1973:1993, Y13w, type="l", lty=2, col="blue3")
lines(1973:1993, Y14w, type="l", lty=2, col="blue2")
legend("bottomright", legend = c("Brazil", "Morocco", "Algeria", "Mexico", "Ghana"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.11), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
legend("topleft", legend = c("Brazil", "Morocco", "Algeria", "Mexico", "Ghana"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.11), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.11), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.12), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/BRA_DEN_2Y.png")
