...
source("controls.R")
canada <- controls(dem, ep_study, c="Canada")
canada_ <- data.frame(Reduce(rbind, canada))
canada_ <- canada_[!(is.na(canada_$country_text_id)),]
canada_c <- unique(canada_$country_name)
canada_in <- canada_[canada_$Continent_Name=="North America" | canada_$Continent_Name=="South America",]
canada_in <- canada_in[!(is.na(canada_in$country_text_id)),]
canada_in_c <- unique(canada_in$country_name)
canada_in_c <- c(canada_in_c, "Canada")
canada_c <- c(canada_c, "Canada")


#####IN AMERiCA ####
db <- db1[which(db1$country %in% canada_in_c),]
db <- db[db$year>1909 & db$year<1931,]
table(db$codenum)

db <- db[which((db$codenum %in% c(13,16,22,26,28,32,38,81,99,101,137))),]

dataprep.out <- dataprep(
  foo = db,
  predictors = c("child_mort", "popg") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1910:1919 ,
  special.predictors = list(
    list("averagegdppc", seq(1915, 1920,5), "mean"),
    list("primary_barro", seq(1910, 1920,5), "mean"),
    list("ggdp", 1915:1920, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(13,16,26,28,32,38,81,99,101,137),
  time.optimize.ssr = 1910:1920,
  time.plot = 1910:1930)
...
plot(1910:1930, Y1, ylim=c(-25,20), type="l", xlab = "Year", ylab = "Canada GDP per capita growth rate")
lines(1910:1930, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15, 15), Legend = c("Canada",
                                        "Synthetic Canada"), Legend.position = "bottomleft")
abline(v=c(1920), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  time.predictors.prior = 1910:1919 ,
  special.predictors = list(
    list("averagegdppc", seq(1910, 1920,5), "mean"),
    list("primary_barro", seq(1910, 1920,5), "mean"),
    list("ggdp", 1910:1920, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  unit.names.variable = "countrycode",
  ...
  controls.identifier = c(13,16,28,32,38,81,99,101,137),
  time.optimize.ssr = 1910:1920,
  time.plot = 1910:1930)
...
plot(1910:1930, Y1plac, ylim=c(-25,20), type="l", xlab = "Year", ylab = "Italy GDP per capita growth rate")
lines(1910:1930, Y1synthplac, type="l", lty=2)


png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-20, 25), Legend = c("Chile",
                                        "Synthetic Chile"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(13,16,26,28,32,38,81,101,137),
  time.optimize.ssr = 1910:1920,
  time.plot = 1910:1930)
...
plot(1910:1930, Y12, ylim=c(-10,10), type="l", xlab = "Year", ylab = "ESP GDP per capita growth rate")
lines(1910:1930, Y1synth2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-7, 15), Legend = c("Panama",
                                        "Synthetic Panama"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac3 <- dataprep(
  ...
  controls.identifier = c(13,16,26,28,32,38,81,137,99),
  time.optimize.ssr = 1910:1920,
  time.plot = 1910:1930)
...
plot(1910:1930, Y13, ylim=c(-10,10), type="l", xlab = "Year", ylab = "ESP GDP per capita growth rate")
lines(1910:1930, Y1synth3, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15, 10), Legend = c("Peru",
                                        "Synthetic Peru"), Legend.position = "bottomleft")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_ALL.png")
plot(1910:1930, Y1, ylim=c(-17,25), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1910:1930, Y1plac, type="l", lty=2, col="blue")
lines(1910:1930, Y12, type="l", lty=2, col="blue4")
lines(1910:1930, Y13, type="l", lty=2, col="blue3")
legend("topleft", legend = c("Canada", "Chile", "Panama", 'Peru'),
...
density[density$effect=="10year", "ATE_country"]<- sum(effects[effects$years>11,"country"])/(11-21)
...
density[density$effect=="10year", "ATE_placebo1"]<- sum(effects[effects$years>11,"placebo1"])/(11-21)
...
density[density$effect=="10year", "ATE_placebo2"]<- sum(effects[effects$years>11,"placebo2"])/(11-21)
...
density[density$effect=="10year", "ATE_placebo3"]<- sum(effects[effects$years>11,"placebo3"])/(11-21)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_DEN_10Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.07), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Canada", "Chile", "Panama", 'Peru'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.07), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Canada", "Chile", "Panama", 'Peru'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_IN_DEN_2Y.png")
...
dbw <- db1[which(db1$country %in% canada_c),]
dbw <- dbw[dbw$year>1909 & dbw$year<1931,]
...
plot(1907:1927, Y1w, ylim=c(-20,20), type="l", xlab = "Year", ylab = "Finland GDP per capita growth rate")
lines(1907:1927, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15, 15), Legend = c("Canada",
                                        "Synthetic Canada"), Legend.position = "bottomright")
abline(v=c(1920), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 26,
  controls.identifier = c(13, 16, 28, 32, 38, 49, 58, 59, 63, 65, 76, 81, 99, 
                          101, 102, 104, 122, 123, 137),
  time.optimize.ssr = 1910:1919,
  time.plot = 1910:1930)
...
plot(1907:1927, Y1placw, ylim=c(-25,20), type="l", xlab = "Year", ylab = "Italy GDP per capita growth rate")
lines(1907:1927, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_PLC1.png")
...
dataprep.out.plac2w <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 99,
  controls.identifier = c(13, 16, 26, 28, 32, 38, 49, 58, 59, 63, 65, 76, 81, 
                          101, 102, 104, 122, 123, 137),
  time.optimize.ssr = 1910:1919,
  time.plot = 1910:1930)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10, 10), Legend = c("Panama",
...
plot(1907:1927, Y13w, ylim=c(-10,10), type="l", xlab = "Year", ylab = "PTR GDP per capita growth rate")
lines(1907:1927, Y1synth3w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5, 10), Legend = c("Spain",
                                        "Synthetic Spain"), Legend.position = "topleft")
dev.off()



png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_ALL.png")
plot(1910:1930, Y1w, ylim=c(-35,20), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1910:1930, Y1placw, type="l", lty=2, col="blue")
lines(1910:1930, Y12w, type="l", lty=2, col="blue4")
lines(1910:1930, Y13w, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("Canada", "Chile", "Panama","Spain"),
       col = c("red", "blue", "blue4", "green4"), lty = C(1,2,2,2), cex = 0.8)
abline(v=c(1920), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.07), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Canada", "Chile", "Panama", "Spain"),
       col = c("red", "blue", "green", "pink"), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.07), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/CAN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.42), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Canada", "Chile", "Panama", "Spain"),
