...
#colombia
source("controls_w.R")
colombia <- controls(dem, ep_study, c="COL")
colombia_ <- data.frame(Reduce(rbind, colombia))
colombia_ <- colombia_[!(is.na(colombia_$country_text_id)),]
colombia_c <- unique(colombia_$country_name)
colombia_in <- colombia_[colombia_$Continent_Name=="North America" | colombia_$Continent_Name=="South America" ,]
colombia_in <- colombia_in[!(is.na(colombia_in$country_text_id)),]
colombia_in_c <- unique(colombia_in$country_name)
colombia_in_c <- c(colombia_in_c, "Colombia")
colombia_c <- c(colombia_c, "Colombia")

#####IN AMERICA ####
db <- db1[which(db1$country %in% colombia_in_c),]
db <- db[db$year>1979 & db$year<2001,]
...
dataprep.out <- dataprep(
  ...
  special.predictors = list(
    ...
    #list("primary_barro", seq(1980, 1990,5), "mean"),
...
plot(1980:2000, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Colombia Real GDP per capita Growth Rate")
lines(1980:2000, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15,10), Legend = c("Colombia",
                                     "Synthetic Colombia"), Legend.position = "bottomleft")
...
plot(1980:2000, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1980:2000, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-25,15), Legend = c("Cuba",
                                       "Synthetic Cuba"), Legend.position = "bottomright")
abline(v=c(2000), col=c("black"), lwd=c(2))
dev.off()
...
plot(1980:2000, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Colombia Real GDP per capita Growth Rate")
lines(1980:2000, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15,10), Legend = c("Haiti",
                                       "Synthetic Haiti"), Legend.position = "bottomleft")
dev.off()

##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_ALL.png")
plot(1980:2000, Y1, ylim=c(-25,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1980:2000, Y1.plac, type="l", lty=2, col="blue")
lines(1980:2000, Y1.plac2, type="l", lty=2, col="blue4")
#lines(1980:2000, Y1.plac3, type="l", lty=2, col="blue2")
legend("bottomleft", legend = c("Colombia", "Cuba", "Haiti"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_DEN_10Y.png")
...
legend("topleft", legend = c("Colombia", "Cuba", 'Haiti'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/COL_IN_DEN_2Y.png")
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% colombia_c),]
...
dataprep.outw <- dataprep(
  ...
  time.predictors.prior = 1980:1990,
  special.predictors = list(
    list("averagegdppc", seq(1980, 1980,5), "mean"),
    list("ggdp", 1987:1990, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  ...
  time.variable = "year",
  treatment.identifier = 31,
  controls.identifier = c(2, 3, 4, 10, 22, 24, 27, 28, 30, 32, 35, 40, 
                          50, 51, 59, 72, 74, 75, 78,
                          81, 85, 86, 89, 94, 97, 102, 106, 107, 120, 122, 
...
plot(1980:2000, Y1w, ylim=c(-5,10), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1980:2000, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6 ,11), Legend = c("Colombia",
                                        "Synthetic Colombia"), Legend.position = "bottomleft")
abline(v=c(1990), col=c("black"), lwd=c(2))
dev.off()
...
plot(1980:2000, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1980:2000, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10,17), Legend = c("Seychelles",
...
dataprep.out.plac2w <- dataprep(
  ...
  controls.identifier = c(3, 4, 10, 22, 24, 27, 28, 30, 32, 35, 40, 
                          50, 51, 59, 74, 75, 78,
                          81, 85, 86, 89, 94, 97, 102, 106, 107, 120, 122, 
                          125, 126, 127, 140, 142, 145, 153, 156),
  time.optimize.ssr = 1980:1990,
...
plot(1980:2000, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1980:2000, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15, 15), Legend = c("Jordan",
                                        "Synthetic Jordan"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3w <- dataprep(
  ...
  controls.identifier = c(2, 3, 4, 22, 24, 27, 28, 30, 32, 35, 40, 
                          50, 51, 59, 72, 74, 75, 78,
                          81, 85, 86, 89, 94, 97, 102, 106, 107, 120, 122, 
                          125, 126, 127, 140, 142, 145, 153, 156),
  time.optimize.ssr = 1980:1990,
...
plot(1980:2000, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1980:2000, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5, 20), Legend = c("Bahrain",
                                        "Synthetic Bahrain"), Legend.position = "bottomright")
dev.off()


png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_ALL.png")
plot(1980:2000, Y1w, ylim=c(-15,20), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1980:2000, Y1placw, type="l", lty=2, col="blue")
lines(1980:2000, Y12w, type="l", lty=2, col="blue4")
lines(1980:2000, Y13w, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("Colombia", "Seychelles", "Jordan", "Bahrain"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.12), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Colombia", "Seychelles", "Jordan",'Bahrain'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/COL_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.2), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Colombia", "Seychelles", "Jordan", 'Bahrain'),
