...
source("controls_w.R")
lesotho <- controls(dem, ep_study, c="LSO")
lesotho_ <- data.frame(Reduce(rbind, lesotho))
lesotho_ <- lesotho_[!(is.na(lesotho_$country_text_id)),]
lesotho_c <- unique(lesotho_$country_name)
lesotho_in <- lesotho_[lesotho_$Continent_Name=="Africa" ,]
lesotho_in <- lesotho_in[!(is.na(lesotho_in$country_text_id)),]
lesotho_in_c <- unique(lesotho_in$country_name)
lesotho_in_c <- c(lesotho_in_c, "Lesotho")
lesotho_c <- c(lesotho_c, "Lesotho")

#####IN AMERICA ####
db <- db1[which(db1$country %in% lesotho_in_c),]
db <- db[db$year>1991 & db$year<2013,]
...
dataprep.out <- dataprep(
  ...
  time.predictors.prior = 1992:2002,
  special.predictors = list(
    list("averagegdppc", seq(1995, 2000,5), "mean"),
    list("ggdp", 1998:2002, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(3, 4, 22, 24, 27, 28, 40, 47, 50, 51, 74, 
                          81, 89, 94, 95, 102, 120, 125, 140, 145, 156),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Lesotho Real GDP per capita Growth Rate")
lines(1992:2012, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-8,10), Legend = c("Lesotho",
                                       "Synthetic Lesotho"), Legend.position = "topleft")
abline(v=c(2002), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  controls.identifier = c(3, 4, 22, 24, 27, 28, 40, 47, 50, 51, 74, 
                          81, 94, 95, 102, 120, 125, 140, 145, 156),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1992:2012, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-5,20), Legend = c("Mauritania",
                                       "Synthetic Mauritania"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(3, 4, 22, 24, 27, 28, 40, 47, 50, 51, 74, 
                          81, 89, 94, 95, 102, 120, 125, 140, 145),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Lesotho Real GDP per capita Growth Rate")
lines(1992:2012, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-18,10), Legend = c("Zimbabwe",
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_IN_ALL.png")
plot(1992:2012, Y1, ylim=c(-18,18), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1992:2012, Y1.plac, type="l", lty=2, col="blue")
lines(1992:2012, Y1.plac2, type="l", lty=2, col="blue4")
legend("bottomleft", legend = c("Lesotho", "Mauritania", "Zimbabwe"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LSO_IN_DEN_10Y.png")
...
legend("topleft", legend = c("Lesotho", "Mauritania", 'Zimbabwe'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LSO_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LSO_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.08), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LSO_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.08), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LSO_IN_DEN_2Y.png")
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% lesotho_c),]
dbw <- dbw[dbw$year>1991 & dbw$year<2013,]
...
dataprep.outw <- dataprep(
  ...
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          ...
                          94, 95, 102, 106, 107, 115, 120, 122, 125, 127, 137, 140, 
                          144, 145, 151, 153, 156),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Lesotho Real GDP per capita Growth Rate")
lines(1992:2012, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6, 12), Legend = c("Lesotho",
                                        "Synthetic Lesotho"), Legend.position = "topleft")
abline(v=c(2002), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <-dataprep(
  ...
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          50, 51, 59,66, 72, 74, 75, 76, 78, 81, 86, 89, 
                          94, 95, 106, 107, 115, 120, 122, 125, 127, 137, 140, 
                          144, 145, 151, 153, 156),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1992:2012, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-21,16), Legend = c("Nigeria",
...
plot(1992:2012, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1992:2012, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_PLC2.png")
...
dataprep.out.plac3w <- dataprep(
  ...
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          50, 51, 59,66, 72, 74, 75, 76, 78, 81, 86, 89, 
                          94, 95, 102, 106, 107, 115, 120, 122, 125, 137, 140, 
                          144, 145, 151, 153, 156),
  time.optimize.ssr = 1992:2002,
  time.plot = 1992:2012)
...
plot(1992:2012, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1992:2012, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_PLC3.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_ALL.png")
plot(1992:2012, Y1w, ylim=c(-17,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1992:2012, Y1placw, type="l", lty=2, col="blue")
lines(1992:2012, Y12w, type="l", lty=2, col="blue4")
lines(1992:2012, Y13w, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("Lesotho", "Nigeria", "Zimbabwe", "Singapore"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Lesotho", "Nigeria", "Zimbabwe", 'Singapore'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Lesotho", "Nigeria", "Zimbabwe", 'Singapore'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LSO_DEN_2Y.png")
