...
source("controls_w.R")
liberia <- controls(dem, ep_study, c="LBR")
liberia_ <- data.frame(Reduce(rbind, liberia))
liberia_ <- liberia_[!(is.na(liberia_$country_text_id)),]
liberia_c <- unique(liberia_$country_name)
liberia_in <- liberia_[liberia_$Continent_Name=="Africa" ,]
liberia_in <- liberia_in[!(is.na(liberia_in$country_text_id)),]
liberia_in_c <- unique(liberia_in$country_name)
liberia_in_c <- c(liberia_in_c, "Liberia")
liberia_c <- c(liberia_c, "Liberia")

#####IN AMERICA ####
db <- db1[which(db1$country %in% liberia_in_c),]
db <- db[db$year>1994 & db$year<2016,]
...
dataprep.out <- dataprep(
  foo = db,
  predictors = c("child_mort", "popg", 'trade', "secondary") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1995:2005,
  special.predictors = list(
    list("averagegdppc", seq(1995, 2005,5), "mean"),
    list("gcf", seq(2000, 2005,5), "mean"),
    list("ggdp", 2001:2005, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(3, 4, 22, 24, 27, 28, 40, 47, 50, 51, 74, 
                          81, 89, 94, 95, 120, 125, 145, 156),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y1, ylim=c(-40,75), type="l", xlab = "Year", ylab = "Liberia Real GDP per capita Growth Rate")
lines(1995:2015, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-40,81), Legend = c("Liberia",
                                       "Synthetic Liberia"), Legend.position = "bottomright")
abline(v=c(2005), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  controls.identifier = c(3, 156, 22, 24, 27, 28, 40, 47, 50, 51, 74, 
                          81, 89, 94, 95, 120, 125, 145),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1995:2015, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-1,27), Legend = c("Angola",
                                       "Synthetic Angola"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(3, 4, 22, 24, 95, 28, 40, 47, 50, 51, 74, 
                          81, 89, 94, 120, 125, 145, 156),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Liberia Real GDP per capita Growth Rate")
lines(1995:2015, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-40,5), Legend = c("Central African Republic",
                                       "Synthetic Central African Republic"), Legend.position = "bottomleft")
dev.off()

##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_IN_ALL.png")
plot(1995:2015, Y1, ylim=c(-40,81), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1995:2015, Y1.plac, type="l", lty=2, col="blue")
lines(1995:2015, Y1.plac2, type="l", lty=2, col="blue4")
#lines(1995:2015, Y1.plac3, type="l", lty=2, col="blue3")
#lines(1995:2015, Y1.plac4, type="l", lty=2, col="blue2")
legend("topright", legend = c("Liberia", "Angola", "Central African Republic"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LBR_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-50,50), ylim=c(0, 0.04), lwd=c(2))
...
legend("topleft", legend = c("Liberia", "Angola", 'Central African Republic'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LBR_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.06), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LBR_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-60,60), ylim=c(0, 0.06), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LBR_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-50,50), ylim=c(0, 0.05), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/LBR_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-70,70), ylim=c(0, 0.04), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% liberia_c),]
dbw <- dbw[dbw$year>1994 & dbw$year<2016,]
...
dataprep.outw <- dataprep(
  ...
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          50, 51, 59, 66, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          95, 106, 107, 115, 120, 122, 125, 127, 137, 144, 145, 147, 
                          151, 153, 156),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1995:2015, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-42, 81), Legend = c("Liberia",
                                        "Synthetic Liberia"), Legend.position = "bottomright")
abline(v=c(2005), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <-dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 147,
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          50, 51, 59, 66, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          95, 106, 107, 115, 120, 122, 125, 127, 137, 144, 145, 
                          151, 153, 156),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1995:2015, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-8,16), Legend = c("United Arab Emirates",
                                       "Synthetic United Arab Emirates"), Legend.position = "bottomleft")
dev.off()
...
plot(1995:2015, Y12w, ylim=c(-20,10), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1995:2015, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-19, 10), Legend = c("Zimbabwe",
                                        "Synthetic Zimbabwe"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3w <- dataprep(
  ...
  controls.identifier = c(1, 3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 47, 
                          50, 51, 59, 66, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          106, 107, 115, 120, 122, 125, 127, 137, 144, 145, 147, 
                          151, 153, 156),
  time.optimize.ssr = 1995:2005,
  time.plot = 1995:2015)
...
plot(1995:2015, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1995:2015, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_PLC2.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-11, 15), Legend = c("Mozambique",
                                        "Synthetic Mozambiqu"), Legend.position = "bottomright")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_ALL.png")
plot(1995:2015, Y1w, ylim=c(-40,81), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1995:2015, Y1placw, type="l", lty=2, col="blue")
lines(1995:2015, Y12w, type="l", lty=2, col="blue4")
lines(1995:2015, Y13w, type="l", lty=2, col="blue3")
legend("topright", legend = c("Liberia", "United Arab Emirates", "Zimbabwe", "Mozambique"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.08), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Liberia", "United Arab Emirates", "Zimbabwe", 'Mozambique'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/LBR_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.18), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Liberia", "United Arab Emirates", "Zimbabwe", 'Mozambique'),
