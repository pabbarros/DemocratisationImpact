...
#Mexico
source("controls_w.R")
mexico <- controls(dem, ep_study, c="MEX")
mexico_ <- data.frame(Reduce(rbind, mexico))
mexico_ <- mexico_[!(is.na(mexico_$country_text_id)),]
mexico_c <- unique(mexico_$country_name)
mexico_in <- mexico_[mexico_$Continent_Name=="North America" | mexico_$Continent_Name=="South America" ,]
mexico_in <- mexico_in[!(is.na(mexico_in$country_text_id)),]
mexico_in_c <- unique(mexico_in$country_name)
mexico_in_c <- c(mexico_in_c, "Mexico")
mexico_c <- c(mexico_c, "Mexico")

#####IN AMERICA ####
db <- db1[which(db1$country %in% mexico_in_c),]
...
plot(1984:2004, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Mexico Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-12,10), Legend = c("Mexico",
                                       "Synthetic Mexico"), Legend.position = "bottomright")
...
dataprep.out.plac <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 59,
  controls.identifier = c(35,91),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-13,10), Legend = c("Haiti",
                                       "Synthetic Haiti"), Legend.position = "bottomright")
dev.off()
...
plot(1984:2004, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Mexico Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-23,15), Legend = c("Cuba",
                                       "Synthetic Cuba"), Legend.position = "bottomright")
dev.off()


##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_ALL.png")
plot(1984:2004, Y1, ylim=c(-22,14), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1984:2004, Y1.plac, type="l", lty=2, col="blue")
lines(1984:2004, Y1.plac2, type="l", lty=2, col="blue4")
legend("bottomright", legend = c("Mexico", "Haiti", "Cuba"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-15,15), ylim=c(0, 0.07), lwd=c(2))
...
legend("topleft", legend = c("Mexico", "Haiti", "Cuba"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.05), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.05), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.04), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/MEX_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-50,50), ylim=c(0, 0.03), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% mexico_c),]
...
dataprep.outw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 91,
  controls.identifier = c(2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          50, 51, 59, 72, 74, 75, 78, 81, 85, 
...
plot(1984:2004, Y1w, ylim=c(-8,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1984:2004, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-8, 8), Legend = c("Mexico",
                                        "Synthetic Mexico"), Legend.position = "bottomright")
abline(v=c(1994), col=c("black"), lwd=c(3))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  controls.identifier = c(2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          50, 51, 59, 72, 74, 75, 78, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 125, 127, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-13,20), Legend = c("Saudi Arabia",
...
dataprep.out.plac2w <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 35,
  controls.identifier =  c(2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 40,
                           50, 51, 59, 72, 74, 75, 78, 81, 85, 
                           86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 122, 125, 127, 
                           140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-23, 23), Legend = c("Cuba",
                                        "Synthetic Cuba"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3w <-dataprep(
  ...
  controls.identifier = c(2, 3, 4, 10, 22, 23, 24, 27, 28, 32, 35, 40,
                          50, 51, 59, 72, 74, 75, 78, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 122, 125, 127, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-2, 10), Legend = c("China",
                                        "Synthetic China"), Legend.position = "bottomright")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_ALL.png")
plot(1984:2004, Y1w, ylim=c(-23,23), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
...
lines(1984:2004, Y14w, type="l", lty=2, col="blue2")
legend("bottomleft", legend = c("Mexico", "Saudi Arabia", "Cuba", "China"),
       col = c("red", "blue", "blue4", "blue3", "blue2"), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(1994), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Mexico", "Saudi Arabia", "Cuba", 'China'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.060), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Mexico", "Saudi Arabia", "Cuba", 'China'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/MEX_DEN_2Y.png")
