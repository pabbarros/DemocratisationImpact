...
##### CONTROLS #####
#Peru
ep_study[ep_study['country_name']=='Peru2', 'country_text_id'] <- 'PER2'
source("controls_w.R")
peru <- controls(dem, ep_study, c="PER2")
peru_ <- data.frame(Reduce(rbind, peru))
peru_ <- peru_[!(is.na(peru_$country_text_id)),]
peru_c <- unique(peru_$country_name)
peru_in <- peru_[peru_$Continent_Name=="North America" | peru_$Continent_Name=="South America" ,]
peru_in <- peru_in[!(is.na(peru_in$country_text_id)),]
peru_in_c <- unique(peru_in$country_name)
peru_in_c <- c(peru_in_c, "Peru")
peru_c <- c(peru_c, "Peru")

#####IN AMERICA ####
db <- db1[which(db1$country %in% peru_in_c),]
db <- db[db$year>1990 & db$year<2012,]
...
dataprep.out <- dataprep(
  ...
  time.predictors.prior = 1991:2001,
  special.predictors = list(
    list("averagegdppc", seq(1995, 2000,5), "mean"),
    list("ggdp", 1998:2001, "mean")
  ),
  dependent = "ggdp",
...
plot(1991:2011, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Peru Real GDP per capita Growth Rate")
lines(1991:2011, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-11,11), Legend = c("Peru",
                                     "Synthetic Peru"), Legend.position = "bottomright")
abline(v=c(2001), col=c("black"), lwd=c(2))
dev.off()
...
plot(1991:2011, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1991:2011, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-23,16), Legend = c("Cuba",
...
plot(1991:2011, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Peru Real GDP per capita Growth Rate")
lines(1991:2011, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_PLC2.png")
...
##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_ALL.png")
plot(1991:2011, Y1, ylim=c(-22,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1991:2011, Y1.plac, type="l", lty=2, col="blue")
lines(1991:2011, Y1.plac2, type="l", lty=2, col="blue4")
legend("bottomright", legend = c("Peru", "Cuba", "Haiti"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-15,15), ylim=c(0, 0.13), lwd=c(2))
...
legend("topleft", legend = c("Peru", "Cuba", "Haiti"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.23), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='pink', lty=2)
abline(v=c(0), col=c("black"), lwd=c(2))
legend("topleft", legend = c("Peru", "Romania", 'Hungary'),
       col = c("red", "blue", "green"), lty = c(1,2,2), cex = 0.8)
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.20), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PER_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.35), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
abline(v=c(0), col=c("black"), lwd=c(1))
legend("topleft", legend = c("Peru", "Cuba", "Haiti"),
       col = c("red", "blue", "green"), lty = c(1,2,2), cex = 0.8)
dev.off()
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% peru_c),]
dbw <- dbw[dbw$year>1990 & dbw$year<2012,]
...
dataprep.outw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 111,
  controls.identifier = c(3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 
                          50, 51, 59, 66, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          95, 102, 106, 107, 115, 120, 122, 125, 127, 137, 140, 
                          142, 144, 145, 151, 153, 156),
  time.optimize.ssr = 1991:2001,
  time.plot = 1991:2011)
...
plot(1991:2011, Y1w, ylim=c(-6,12), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1991:2011, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6, 12), Legend = c("Peru",
...
dataprep.out.placw <- dataprep(
  ...
  controls.identifier = c(3, 4, 10, 22, 23, 24, 27, 28, 30, 35, 40, 
                          50, 51, 59, 66, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          95, 102, 106, 107, 115, 120, 122, 125, 137, 140, 
                          142, 144, 145, 151, 153, 156),
  time.optimize.ssr = 1991:2001,
  time.plot = 1991:2011)
...
plot(1991:2011, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1991:2011, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,15), Legend = c("Singapore",
                                       "Synthetic Singapore"), Legend.position = "bottomright")
dev.off()
...
plot(1991:2011, Y12w, ylim=c(-15,10), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1991:2011, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_PLC2.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_ALL.png")
plot(1991:2011, Y1w, ylim=c(-17,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1991:2011, Y1placw, type="l", lty=2, col="blue")
lines(1991:2011, Y12w, type="l", lty=2, col="blue4")
legend("bottomleft", legend = c("Peru", "Singapore", "Zimbabwe"),
       col = c("red", "blue", "blue4"), lty = c(1,2,2), cex = 0.8)
abline(v=c(2001), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.08), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Peru", "Singapore", "Zimbabwe"),
       col = c("red", "blue", "green"), lty = c(1,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
legend("topleft", legend = c("Peru", "Singapore", "Zimbabwe"),
       col = c("red", "blue", "green"), lty = c(1,2,2), cex = 0.8)
...
norm_data <-
  rnorm(
    n = 1000000,
    mean = density[density$effect=='4year','ATE_country'],
    sd = std[std$years=='std_4', 'country']
  )
...
norm_datap1 <-
  rnorm(
    n = 1000000,
    mean = density[density$effect=='4year','ATE_placebo1'],
    sd = std[std$years=='std_4', 'placebo1']
  )
...
norm_datap2 <-
  rnorm(
    n = 1000000,
    mean = density[density$effect=='4year','ATE_placebo2'],
    sd = std[std$years=='std_4', 'placebo2']
  )


png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PER_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.09), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Peru", "Singapore", "Zimbabwe"),
