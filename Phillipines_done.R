...
#Phillipes
source("controls_w.R")
phillipines <- controls(dem, ep_study, c="PHL")
phillipines_ <- data.frame(Reduce(rbind, phillipines))
phillipines_ <- phillipines_[!(is.na(phillipines_$country_text_id)),]
phillipines_c <- unique(phillipines_$country_name)
phillipines_in <- phillipines_[phillipines_$Continent_Name=="Asia" | phillipines_$Continent_Name=="Oceania" ,]
phillipines_in <- phillipines_in[!(is.na(phillipines_in$country_text_id)),]
phillipines_in_c <- unique(phillipines_in$country_name)
phillipines_in_c <- c(phillipines_in_c, "Philippines")
phillipines_c <- c(phillipines_c, "Philippines")

#####IN ASIA/OCEANIA ####
db <- db1[which(db1$country %in% phillipines_in_c),]
db <- db[db$year>1975 & db$year<1997,]
...
dataprep.out <- dataprep(
  ...
  time.predictors.prior = 1976:1986,
  special.predictors = list(
    list("averagegdppc", seq(1980, 1985,5), "mean"),
    list("ggdp", 1983:1986, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(1, 10, 23, 30, 65, 66, 72, 75, 78, 86, 97, 106, 107,
                          115, 122, 127, 139, 153),
  time.optimize.ssr = 1976:1986,
  time.plot = 1976:1996)
...
plot(1976:1996, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-11,15), Legend = c("Phillipines",
                                     "Synthetic Phillipines"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  controls.identifier = c(1, 97, 23, 30, 65, 66, 72, 75, 78, 86, 107,
                          115, 122, 127, 139, 153),
  time.optimize.ssr = 1976:1986,
  time.plot = 1976:1996)
...
plot(1976:1996, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,15), Legend = c("Bahrain",
                                       "Synthetic Bahrain"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 86,
  controls.identifier = c(1, 10, 23, 30, 65, 66, 72, 75, 78, 122, 97, 106, 107,
                          115, 127, 139, 153),
  time.optimize.ssr = 1976:1986,
  time.plot = 1976:1996)
...
plot(1976:1996, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4,10), Legend = c("Saudi Arabia",
                                       "Synthetic Saudi Arabia"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3 <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 66,
  controls.identifier = c(1, 10, 23, 30, 65, 127, 72, 75, 78, 122, 97, 106, 107,
                          115, 86, 139, 153),
  time.optimize.ssr = 1976:1986,
  time.plot = 1976:1996)
...
plot(1976:1996, Y1.plac3 , ylim=c(-2,10), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth.plac3, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-63,40), Legend = c("Iraq",
                                       "Synthetic Iraq"), Legend.position = "bottomleft")
dev.off()


##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_ALL_IN.png")
plot(1976:1996, Y1, ylim=c(-20,30), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1976:1996, Y1.plac, type="l", lty=2, col="blue")
lines(1976:1996, Y1.plac2, type="l", lty=2, col="blue4")
lines(1971:1991, Y1.plac3, type="l", lty=2, col="blue3")
legend("bottomright", legend = c("Phillipines", "Bahrain", "Saudi Arabia",'Iraq'),
       col = c("red", "blue", "blue4", 'blue3' ), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(1986), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PHL_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.08), lwd=c(2))
...
legend("topleft", legend = c("Phillipines", "Bahrain", "Saudi Arabia",'Iraq'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PHL_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PHL_IN_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PHL_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.06), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Bahrain", "Saudi Arabia",'Iraq'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PHL_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.05), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Bahrain", "Saudi Arabia",'Iraq'),
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% phillipines_c),]
dbw <- dbw[dbw$year>1975 & dbw$year<1997,]
...
dataprep.outw <- dataprep(
  foo = dbw,
  predictors = c("child_mort", "popg", "trade", "gcf") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1976:1986,
  special.predictors = list(
    list("averagegdppc", seq(1980, 1985,5), "mean"),
    list("primary_barro", seq(1980, 1985,5), "mean"),
    list("ggdp", 1983:1986, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  ...
  time.variable = "year",
  treatment.identifier = 112,
  controls.identifier = c(2, 3, 23, 24, 30, 35,
                          43, 44, 56, 65, 66, 74,
                          85, 86, 94, 95,
                          126, 139, 142, 145, 
                          156),
...
plot(1976:1996, Y1w, ylim=c(-11,10), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1976:1996, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-11, 11), Legend = c("Phillipines",
                                        "Synthetic Phillipines"), Legend.position = "bottomright")
abline(v=c(1986), col=c("black"), lwd=c(2))
dev.off()
...
plot(1976:1996, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1976:1996, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10,10), Legend = c("Malaysia",
                                       "Synthetic Malaysia"), Legend.position = "bottomleft")
dev.off()
...
plot(1976:1996, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-17, 15), Legend = c("Mozambique",
                                        "Synthetic Mozambique"), Legend.position = "topleft")
dev.off()
...
plot(1976:1996, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1976:1996, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-12, 13), Legend = c("Guatemala",
                                        "Synthetic Guatemala"), Legend.position = "bottomleft")
dev.off()



png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_ALL.png")
plot(1976:1996, Y1w, ylim=c(-14,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1976:1996, Y1placw, type="l", lty=2, col="blue")
lines(1976:1996, Y12w, type="l", lty=2, col="blue4")
lines(1976:1996, Y13w, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
       col = c("red", "blue", "blue4", "blue3"), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(1986), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
       col = c("red", "blue", "green", 'pink'), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.4), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.4), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.6), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PHL_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.45), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Phillipines", "Malaysia", "Mozambique", "Guatemala"),
