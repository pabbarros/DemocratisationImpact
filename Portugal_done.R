...
#Portugal
source("controls_w.R")
portugal <- controls(dem, ep_study, c="PRT")
portugal_ <- data.frame(Reduce(rbind, portugal))
portugal_ <- portugal_[!(is.na(portugal_$country_text_id)),]
portugal_c <- unique(portugal_$country_name)
portugal_in <- portugal_[portugal_$Continent_Name=="Europe",]
portugal_in <- portugal_in[!(is.na(portugal_in$country_text_id)),]
portugal_in_c <- unique(portugal_in$country_name)
portugal_in_c <- c(portugal_in_c, "Portugal")
portugal_c <- c(portugal_c, "Portugal")

#####IN EUROPE ####
db <- db1[which(db1$country %in% portugal_in_c),]
db <- db[db$year>1959 & db$year<1981,]
...
db2 <- db2[which(db2$country %in% portugal_in_c),]
db2 <- db2[db2$year>1959 & db2$year<1981,]
table <- as.data.frame(table(db2$codenum))
table <- table[table$Freq==21,]
table$Var1 <- as.factor(table$Var1)
c <- as.vector(table$Var1)
c <- as.numeric(c)
...
table(db$codenum)
db2 <- db2[which((db2$codenum %in% c)),]

db3 <- db3[which(db3$country %in% portugal_in_c),]
db3 <- db3[db3$year>1959 & db3$year<1981,]
table <- as.data.frame(table(db3$codenum))
table <- table[table$Freq==21,]
table$Var1 <- as.factor(table$Var1)
c <- as.vector(table$Var1)
c <- as.numeric(c)
...
table(db$codenum)
db3 <- db3[which((db3$codenum %in% c)),]

db4 <- db4[which(db4$country %in% portugal_in_c),]
db4 <- db4[db4$year>1959 & db4$year<1981,]
table <- as.data.frame(table(db4$codenum))
table <- table[table$Freq==21,]
table$Var1 <- as.factor(table$Var1)
c <- as.vector(table$Var1)
c <- as.numeric(c)
...
table(db$codenum)
db4 <- db4[which((db4$codenum %in% c)),]

dbfinal <- db5[which(db5$country %in% portugal_in_c),]
dbfinal <- dbfinal[dbfinal$year>1959 & dbfinal$year<1981,]
...
dataprep.out <- dataprep(
  ...
  special.predictors = list(
    list("averagegdppc", seq(1965, 1970,5), "mean"),
    list("ggdp", 1967:1970, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(20, 62, 113, 117),
...
plot(1960:1980, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal GDP per capita growth rate")
lines(1960:1980, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-8,13), Legend = c("Portugal",
                                       "Synthetic Portugal"), Legend.position = "bottomleft")
abline(v=c(1970), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <- dataprep(
  ...
  controls.identifier = c(62, 113, 20),
  time.optimize.ssr = 1960:1970,
  time.plot = 1960:1980)
...
plot(1960:1980, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN GDP per capita growth rate")
lines(1960:1980, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,13), Legend = c("Romania",
                                       "Synthetic Romania"), Legend.position = "bottomleft")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 62,
  controls.identifier = c(20, 117, 113),
  time.optimize.ssr = 1960:1970,
  time.plot = 1960:1980)
...
plot(1960:1980, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal GDP per capita growth rate")
lines(1960:1980, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4,8), Legend = c("Hungary",
                                       "Synthetic Hungary"), Legend.position = "bottomleft")
dev.off()

##ALL PLACEBOS

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_ALL.png")
plot(1960:1980, Y1, ylim=c(-8,13), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
lines(1960:1980, Y1.plac, type="l", lty=2, col="blue")
lines(1960:1980, Y1.plac2, type="l", lty=2, col="blue4")
legend("bottomleft", legend = c("Portugal", "Romania", "Hungary"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_DEN_10Y.png")
...
legend("topleft", legend = c("Portugal", "Romania", "Hungary"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.22), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/PRT_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-25,25), ylim=c(0, 0.2), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
##### IN WORLD ####
dbw <- db5[which(db5$country %in% portugal_c),]
dbw <- dbw[dbw$year>1959 & dbw$year<1981,]
...
dataprep.outw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 114,
  controls.identifier = c(1, 3, 15, 16, 19, 20, 21, 22, 23, 27, 28, 30, 
                          31, 32, 35, 38, 41, 43, 44, 47, 50, 51, 54, 56, 57, 58, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 
                          87, 89, 91, 94, 95, 100, 101, 102, 106, 107, 109, 
                          110, 111, 112, 115, 117, 120, 121, 122, 123, 125, 
                          126, 127, 131, 138, 139, 140, 142, 145, 154, 155, 156),
  time.optimize.ssr = 1960:1970,
  time.plot = 1960:1980)
...
plot(1960:1980, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal GDP per capita growth rate")
lines(1960:1980, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-8, 12), Legend = c("Portugal",
                                        "Synthetic Portugal"), Legend.position = "bottomleft")
abline(v=c(1970), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  controls.identifier = c(1, 3, 15, 16, 19, 21, 22, 23, 27, 28, 30, 
                          31, 32, 35, 38, 41, 43, 44, 47, 50, 51, 54, 56, 57, 58, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 
                          87, 89, 91, 94, 95, 100, 101, 102, 106, 107, 109, 
                          110, 111, 112, 115, 117, 120, 121, 122, 123, 125, 
...
plot(1960:1980, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO GDP per capita growth rate")
lines( 1960:1980, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4,11), Legend = c("Bulgaria",
                                        "Synthetic Bulgaria"), Legend.position = "bottomleft")
dev.off()
...
dataprep.out.plac2w <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 57,
  controls.identifier = c(1, 3, 15, 16, 19, 21, 22, 23, 27, 28, 30, 
                          31, 32, 35, 38, 41, 43, 44, 47, 50, 51, 54, 56, 20, 58, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 
                          87, 89, 91, 94, 95, 100, 101, 102, 106, 107, 109, 
                          110, 111, 112, 115, 117, 120, 121, 122, 123, 125, 
                          126, 127, 131, 138, 139, 140, 142, 145, 154, 155, 156),
...
plot(1960:1980, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR GDP per capita growth rate")
lines(1960:1980, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-20, 20), Legend = c("Guinea Bissau",
                                        "Synthetic Guinea Bissau"), Legend.position = "bottomleft")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_ALL.png")
plot(1960:1980, Y1w, ylim=c(-18,11), type="l", xlab = "Year", ylab = "GDP per capita growth rate", col="red",lwd=c(2))
lines(1960:1980, Y1placw, type="l", lty=2, col="blue")
lines(1960:1980, Y12w, type="l", lty=2, col="blue4")
legend("bottomleft", legend = c("Portugal", "Bulgaria", "Guinea Bissau"),
       col = c("red", "blue", "blue4"), lty = c(1,2,2), cex = 0.8)
abline(v=c(1970), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.06), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Portugal", "Bulgaria", "Guinea Bissau"),
       col = c("red", "blue", "green"), lty = c(1,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.08), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Portugal", "Bulgaria", "Guinea Bissau"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/PRT_DEN_2Y.png")
