...
#Serbia
source("controls_w.R")
serbia <- controls(dem, ep_study, c="SRB")
serbia_ <- data.frame(Reduce(rbind, serbia))
serbia_ <- serbia_[!(is.na(serbia_$country_text_id)),]
serbia_c <- unique(serbia_$country_name)
serbia_in <- serbia_[serbia_$Continent_Name=="Europe",]
serbia_in <- serbia_in[!(is.na(serbia_in$country_text_id)),]
serbia_in_c <- unique(serbia_in$country_name)
serbia_in_c <- c(serbia_in_c, "Serbia")
serbia_c <- c(serbia_c, "Serbia")

#####IN EUROPE ####
"not possible since there is no country in the donnor pool"


#####IN WORLD ####
dbw <- db1[which(db1$country %in% serbia_c),]
dbw <- dbw[dbw$year>1989 & dbw$year<2011,]
...
dataprep.outw <- dataprep(
  ...
  special.predictors = list(
    list("averagegdppc", seq(1990, 2000,5), "mean"),
    list("gcff", 1995:2000, "mean"),
    list("ggdp", 1997:2000, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(3, 10, 22, 23, 24, 27, 28, 30, 35, 40, 43, 45,
                          50, 51, 57, 58, 59, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
...
plot(1990:2010, Y1w, ylim=c(-30,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1990:2010, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-30, 17), Legend = c("Serbia",
                                        "Synthetic Serbia"), Legend.position = "bottomright")
abline(v=c(2000), col=c("black"), lwd=c(3))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  controls.identifier = c(3, 10, 22, 23, 24, 27, 28, 30, 40, 43, 45,
                          50, 51, 57, 58, 59, 72, 74, 75, 76, 78, 81, 86, 89, 94, 
                          95, 102, 106, 107, 115, 120, 122, 125, 127, 137, 140, 
                          142, 145, 151, 153, 156),
  time.optimize.ssr = 1990:2000,
...
plot(1990:2010, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1990:2010, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-25,16), Legend = c("Cuba",
...
dataprep.out.plac2w <- dataprep(
  ...
  controls.identifier = c(3, 10, 22, 23, 24, 27, 28, 30, 35, 40, 43, 45,
                          50, 51, 57, 58, 59, 72, 74, 122, 76, 78, 81, 86, 89, 94, 
                          95, 102, 106, 107, 115, 120, 125, 127, 137, 140, 
                          142, 145, 151, 153, 156),
  time.optimize.ssr = 1990:2000,
  time.plot = 1990:2010)
...
plot(1990:2010, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1990:2010, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-40, 110), Legend = c("Kuwait",
                                        "Synthetic Kuwait"), Legend.position = "bottomright")
dev.off

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_ALL.png")
plot(1990:2010, Y1w, ylim=c(-30,100), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1990:2010, Y1placw, type="l", lty=2, col="blue")
lines(1990:2010, Y12w, type="l", lty=2, col="blue4")
legend("bottomright", legend = c("Serbia", "Cuba", "Kuwait"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-40,40), ylim=c(0, 0.11), lwd=c(2))
...
legend("topleft", legend = c("Serbia", "Cuba", "Kuwait"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/SRB_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.17), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
#lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Serbia", "Cuba", "Kuwait"),
