...
source("controls_w.R")
southafrica <- controls(dem, ep_study, c="ZAF")
southafrica_ <- data.frame(Reduce(rbind, southafrica))
southafrica_ <- southafrica_[!(is.na(southafrica_$country_text_id)),]
southafrica_c <- unique(southafrica_$country_name)
southafrica_in <- southafrica_[southafrica_$Continent_Name=="Africa" ,]
southafrica_in <- southafrica_in[!(is.na(southafrica_in$country_text_id)),]
southafrica_in_c <- unique(southafrica_in$country_name)
southafrica_in_c <- c(southafrica_in_c, "South Africa")
southafrica_c <- c(southafrica_c, "South Africa")

#####IN AMERICA ####
db <- db1[which(db1$country %in% southafrica_in_c),]
db <- db[db$year>1983 & db$year<2005,]
...
dataprep.out <- dataprep(
  foo = db,
  predictors = c("child_mort", "popg", "secondary", "gcf") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1984:1994,
  special.predictors = list(
    list("averagegdppc", seq(1985, 1990,5), "mean"),
    list("ggdp", 1991:1994, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 130,
  controls.identifier = c(3, 4, 22, 24, 27, 28, 32, 40, 47, 50, 51, 
                          74, 80, 81, 85, 89, 94, 95, 102, 120, 125, 140, 142, 145, 
                          156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1, ylim=c(-10,15), type="l", xlab = "Year", ylab = "South Africa Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,8), Legend = c("South Africa",
                                       "Synthetic South Africa"), Legend.position = "bottomright")
abline(v=c(1994), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.plac <-  dataprep(
  ...
  controls.identifier = c(3, 4, 22, 24, 27, 28, 32, 40, 47, 50, 51, 
                          74, 80, 81, 85, 89, 94, 95, 102, 120, 140, 142, 145, 
                          156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6,18), Legend = c("Seychelles",
                                       "Synthetic Seychelles"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac2 <-  dataprep(
  ...
  controls.identifier = c(51, 4, 22, 24, 27, 28, 32, 40, 47, 50, 
                          74, 80, 81, 85, 89, 94, 95, 102, 120, 125, 140, 142, 145, 
                          156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "South Africa Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,10), Legend = c("Algeria",
                                       "Synthetic Algeria"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3 <-  dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 156,
  controls.identifier = c(3, 4, 22, 24, 27, 28, 32, 40, 47, 51,
                          74, 80, 81, 85, 89, 94, 95, 102, 120, 125, 140, 142, 145, 
                          50),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1.plac3 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "South Africa Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth.plac3, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-17,10), Legend = c("Zimbabwe",
                                       "Synthetic Zimbabwe"), Legend.position = "bottomleft")
dev.off()

##ALL PLACEBOS
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_ALL.png")
plot(1984:2004, Y1, ylim=c(-17,17), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1984:2004, Y1.plac, type="l", lty=2, col="blue")
lines(1984:2004, Y1.plac2, type="l", lty=2, col="blue4")
lines(1984:2004, Y1.plac3, type="l", lty=2, col="blue3")
legend("topleft", legend = c("South Africa", "Seychelles", 'Algeria','Zimbabwe'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-50,50), ylim=c(0, 0.13), lwd=c(2))
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/ZAF_IN_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-10,10), ylim=c(0, 0.65), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% southafrica_c),]
dbw <- dbw[dbw$year>1983 & dbw$year<2005,]
...
dataprep.outw <- dataprep(
  ...
  controls.identifier = c(1, 2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          47, 50, 51, 59, 66, 72, 74, 75, 78, 80, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 122, 125, 127, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1984:2004, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-5, 20), Legend = c("South Africa",
                                        "Synthetic South Africa"), Legend.position = "bottomright")
abline(v=c(1994), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <-dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 97,
  controls.identifier = c(1, 2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          47, 50, 51, 59, 66, 72, 74, 75, 78, 80, 81, 85, 
                          86, 89, 94, 95, 102, 106, 107, 115, 120, 122, 125, 127, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1984:2004, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-3,9), Legend = c("Nepal",
                                       "Synthetic Nepal"), Legend.position = "bottomleft")
dev.off()
...
dataprep.out.plac2w <-  dataprep(
  ...
  controls.identifier = c(1, 2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          47, 50, 51, 59, 66, 72, 74, 75, 78, 80, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 125, 120, 122, 127, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-25, 40), Legend = c("Qatar",
                                        "Synthetic Qatar"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3w <- dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 80,
  controls.identifier = c(1, 2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          47, 50, 51, 59, 66, 72, 74, 75, 78, 156, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 122, 125, 127, 
                          140, 142, 145, 153),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-50, 81), Legend = c("Liberia",
                                        "Synthetic Liberia"), Legend.position = "topleft")
dev.off()
...
dataprep.out.plac4w <- dataprep(
  ...
  controls.identifier = c(1, 2, 3, 4, 10, 22, 23, 24, 27, 28, 30, 32, 35, 40,
                          47, 50, 51, 59, 66, 72, 74, 75, 78, 81, 85, 
                          86, 89, 94, 95, 97, 102, 106, 107, 115, 120, 122, 125, 80, 
                          140, 142, 145, 153, 156),
  time.optimize.ssr = 1984:1994,
  time.plot = 1984:2004)
...
plot(1984:2004, Y14w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1984:2004, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_PLC4.png")
path.plot(synth.res = synth.out.plac4w, dataprep.res = dataprep.out.plac4w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-9, 10), Legend = c("Singapore",
                                        "Synthetic Singapore"), Legend.position = "bottomleft")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_ALL.png")
plot(1984:2004, Y1w, ylim=c(-50,80), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1984:2004, Y1placw, type="l", lty=2, col="blue")
lines(1984:2004, Y12w, type="l", lty=2, col="blue4")
lines(1984:2004, Y13w, type="l", lty=2, col="blue3")
lines(1984:2004, Y14w, type="l", lty=2, col="blue1")
legend("topleft", legend = c("South Africa", "Nepal", 'Qatar', "Liberia", "Singapore"),
       col = c("red", "blue", "blue4", "blue3", 'blue1'), lty = c(1,2,2,2, 2), cex = 0.8)
abline(v=c(1994), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_DEN_10Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.05), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/ZAF_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.1), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
