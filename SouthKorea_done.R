...
#SouthKorea
source("controls_w.R")
southkorea <- controls(dem, ep_study, c="KOR")
southkorea_ <- data.frame(Reduce(rbind, southkorea))
southkorea_ <- southkorea_[!(is.na(southkorea_$country_text_id)),]
southkorea_c <- unique(southkorea_$country_name)
southkorea_in <- southkorea_[southkorea_$Continent_Name=="Asia" | southkorea_$Continent_Name=="Oceania" ,]
southkorea_in <- southkorea_in[!(is.na(southkorea_in$country_text_id)),]
southkorea_in_c <- unique(southkorea_in$country_name)
southkorea_in_c <- c(southkorea_in_c, "South Korea")
southkorea_c <- c(southkorea_c, "South Korea")

#####IN ASIA/OCEANIA ####
db <- db1[which(db1$country %in% southkorea_in_c),]
db <- db[db$year>1970 & db$year<1992,]
...
dataprep.out <- dataprep(
  ...
  time.predictors.prior = 1971:1981,
  special.predictors = list(
    list("averagegdppc", seq(1975, 1980,5), "mean"),
    list("ggdp", 1978:1981, "mean")
  ),
  dependent = "ggdp",
  unit.variable = "codenum",
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 131,
  controls.identifier = c(1, 10, 11, 23, 30, 65, 66, 72, 75, 78, 86, 97, 106, 107, 
                          115, 122, 127, 139, 147),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y1, ylim=c(-10,14), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4,13), Legend = c("South Korea",
                                     "Synthetic South Korea"), Legend.position = "bottomleft")
abline(v=c(1981), col=c("black"), lwd=c(2))
dev.off()
...
plot(1971:1991, Y1.plac, ylim=c(-10,15), type="l", xlab = "Year", ylab = "HUN Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth.plac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-2,12), Legend = c("Singapore",
                                       "Synthetic Singapore"), Legend.position = "topright")
dev.off()
...
dataprep.out.plac2 <- dataprep(
  ...
  controls.identifier = c(1, 10, 11, 23, 30, 66, 72, 75, 78, 97, 106, 107, 
                          115, 122, 127, 139, 147),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y1.plac2 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth.plac2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-6,13), Legend = c("Indonesia",
                                       "Synthetic Indonesia"), Legend.position = "bottomleft")
dev.off()
...
dataprep.out.plac3 <- dataprep(
  ...
  controls.identifier = c(1, 10, 11, 23, 65, 66, 72, 75, 78, 86, 97, 106, 107, 
                          115, 122, 127, 139, 147),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y1.plac3 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth.plac3, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-5,11), Legend = c("China",
                                       "Synthetic China"), Legend.position = "bottomright")
dev.off()

##Placebo 4
dataprep.out.plac4 <- dataprep(
  foo = db,
  predictors = c("child_mort", "popg", "trade", "gcf", "secondary") ,
  predictors.op = c("mean"),
  time.predictors.prior = 1971:1981,
  ...
  controls.identifier = c(1, 10, 106, 23, 30, 65, 66, 72, 75, 78, 86, 97, 107, 
                          115, 122, 127, 139, 147),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)


dataprep.out.plac4$X1
dataprep.out.plac4$Z1

synth.out.plac4 <- synth(dataprep.out.plac4)

synth.tables.plac4 <- synth.tab(dataprep.res = dataprep.out.plac4, synth.res = synth.out.plac4)
synth.tables.plac4$tab.w
synth.tables.plac4$tab.pred

Y1.plac4  <- dataprep.out.plac4$Y1
Y1synth.plac4 <- dataprep.out.plac4$Y0 %*% synth.out.plac4$solution.w
plot(1971:1991, Y1.plac4 , ylim=c(-10,15), type="l", xlab = "Year", ylab = "Portugal Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth.plac4, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_PLC4.png")
path.plot(synth.res = synth.out.plac4, dataprep.res = dataprep.out.plac4,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-15,11), Legend = c("Bangladesh",
                                       "Synthetic Bangladesh"), Legend.position = "bottomright")
dev.off()

##ALL PLACEBOS

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_ALL.png")
plot(1971:1991, Y1, ylim=c(-15,15), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1971:1991, Y1.plac, type="l", lty=2, col="blue")
lines(1971:1991, Y1.plac2, type="l", lty=2, col="blue4")
lines(1971:1991, Y1.plac3, type="l", lty=2, col="blue3")
lines(1971:1991, Y1.plac4, type="l", lty=2, col="blue4")
legend("bottomright", legend = c("South Korea", "Singapore", "Malaysia", "China", "Bangladesh"),
       col = c("red", "blue", "blue4", "blue3", "blue4"), lty = c(1,2,2,2,2), cex = 0.8)
abline(v=c(1981), col=c("black"), lwd=c(2))
dev.off()
...
effects['placebo4'] <- (Y1.plac3 - Y1synth.plac4)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.25), lwd=c(2))
...
legend("topleft", legend = c("South Korea", "Singapore", 'Malaysia','China', 'Bangladesh'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.2), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.25), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_DEN_3Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/KOR_IN_DEN_2Y.png")
...
##### IN WORLD ####
dbw <- db1[which(db1$country %in% southkorea_c),]
dbw <- dbw[dbw$year>1970 & dbw$year<1992,]
...
dataprep.outw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 131,
  controls.identifier = c(1, 2, 3, 4, 10, 11, 15, 21, 22, 23, 24, 27, 28, 30, 32, 35, 
                          40, 44, 47, 50, 51, 54, 56, 59, 65, 66, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 87, 89, 91, 94, 95, 
                          97, 101, 102, 106, 107, 110, 115, 120, 121, 122, 125, 126, 
                          127, 138, 139, 140, 142, 145, 147, 155, 156),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y1w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1971:1991, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR.png")
path.plot(synth.res = synth.outw, dataprep.res = dataprep.outw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4, 14), Legend = c("South Korea",
                                        "Synthetic South Korea"), Legend.position = "bottomright")
abline(v=c(1981), col=c("black"), lwd=c(2))
dev.off()
...
dataprep.out.placw <- dataprep(
  ...
  time.variable = "year",
  treatment.identifier = 127,
  controls.identifier = c(1, 2, 3, 4, 10, 11, 15, 22, 23, 24, 27, 28, 30, 32, 35, 
                          40, 44, 47, 50, 51, 54, 56, 59, 65, 66, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 87, 89, 91, 94, 95, 
                          97, 101, 102, 106, 107, 110, 115, 120, 121, 122, 125, 126, 
                          138, 139, 140, 142, 145, 147, 155, 156),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y1placw, ylim=c(-40,15), type="l", xlab = "Year", ylab = "AGO Real GDP per capita Growth Rate")
lines( 1971:1991, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_PLC1.png")
...
dataprep.out.plac2w <- dataprep(
  ...
  controls.identifier = c(1, 2, 3, 4, 10, 11, 15, 21, 22, 23, 24, 27, 28, 32, 35, 
                          40, 44, 47, 50, 51, 54, 56, 59, 65, 66, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 87, 89, 91, 94, 95, 
                          97, 101, 30, 106, 107, 110, 115, 120, 121, 122, 125, 126, 
                          127, 138, 139, 140, 142, 145, 147, 155, 156),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y12w, ylim=c(-10,15), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-12, 10), Legend = c("Nigeria",
                                        "Synthetic Nigeria"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac3w <- dataprep(
  ...
  controls.identifier = c(1, 2, 3, 4, 10, 11, 15, 21, 22, 23, 24, 27, 28, 32, 35, 
                          40, 44, 47, 50, 51, 54, 56, 59, 65, 66, 
                          72, 74, 75, 78, 80, 81, 84, 85, 86, 87, 89, 91, 94, 95, 
                          97, 101, 106, 107, 110, 115, 120, 121, 122, 125, 126, 
                          127, 138, 139, 140, 142, 145, 147, 155, 156),
  time.optimize.ssr = 1971:1991,
  time.plot = 1971:1991)
...
plot(1971:1991, Y13w, ylim=c(-20,80), type="l", xlab = "Year", ylab = "PTR Real GDP per capita Growth Rate")
lines(1971:1991, Y1synth2w, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_PLC3.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_ALL.png")
plot(1971:1991, Y1w, ylim=c(-10,14), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red", lwd=c(2))
lines(1971:1991, Y1placw, type="l", lty=2, col="blue")
lines(1971:1991, Y12w, type="l", lty=2, col="blue4")
lines(1971:1991, Y13w, type="l", lty=2, col="blue3")
legend("bottomleft", legend = c("South Korea", "Singapore", "Nigeria", "China"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.17), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("South Korea", "Singapore", "Nigeria", "China"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.25), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.27), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("South Korea", "Singapore", "Nigeria", "China"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/KOR_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.25), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("South Korea", "Singapore", "Nigeria", "China"),
