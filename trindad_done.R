...
#Trindad in America
source("controls_w.R")
trindad <- controls(dem, ep_study, c="TTO")
trindad_ <- data.frame(Reduce(rbind, trindad))
trindad_ <- trindad_[!(is.na(trindad_$country_text_id)),]
trindad_c <- unique(trindad_$country_name)
trindad_in <- trindad_[trindad_$Continent_Name=="North America" | trindad_$Continent_Name=="South America",]
trindad_in <- trindad_in[!(is.na(trindad_in$country_text_id)),]
trindad_in_c <- unique(trindad_in$country_name)
trindad_in_c <- c(trindad_in_c, "Trinidad and Tobago")
trindad_c <- c(trindad_c, "Trinidad and Tobago")


#####IN EUROPE ####
db <- db1[which(db1$country %in% trindad_in_c),]
...
table(db$codenum)
db <- db[which((db$codenum %in% c(16, 19, 31, 35, 41, 42, 44, 56, 59, 60, 91, 100, 108, 109, 
                                   110, 139))),]
...
dataprep.out <- dataprep(
  ...
  special.predictors = list(
    list("averagegdppc", seq(1951, 1960,4), "mean"),
  ...
  time.variable = "year",
  treatment.identifier = 139,
  controls.identifier = c(16, 19, 31, 35, 41, 42, 44, 56, 60, 91, 100, 108, 109, 
                           110),
...
plot(1951:1970, Y1, ylim=c(-20,20), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1951:1970, Y1synth, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_IN.png")
path.plot(synth.res = synth.out, dataprep.res = dataprep.out,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4, 18), Legend = c("Trinidad and Tobago",
                                        "Synthetic Trinidad and Tobago"), Legend.position = "bottomright")
...
dataprep.out.plac <- dataprep(
  ...
  time.predictors.prior = 1951:1970 ,
  special.predictors = list(
    list("gdp5average", seq(1951, 1960,4), "mean"),
    list("primary_barro", seq(1955, 1960,5), "mean"),
    list("ggdp", 1957:1960, "mean")
  ),
  dependent = "ggdp",
  ...
  controls.identifier = c(31, 35, 41, 42, 44, 60, 91, 100, 108, 109, 
                          110),
  time.optimize.ssr = 1951:1960,
  time.plot = 1951:1970)
...
plot(1951:1970, Y1plac, ylim=c(-5,10), type="l", xlab = "Year", ylab = "Italy Real GDP per capita Growth Rate")
lines(1951:1970, Y1synthplac, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_IN_PLC1.png")
path.plot(synth.res = synth.out.plac, dataprep.res = dataprep.out.plac,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-3, 9), Legend = c("Brazil",
                                        "Synthetic Brazil"), Legend.position = "bottomright")
dev.off()
...
dataprep.out.plac2 <-  dataprep(
  ...
  controls.identifier = c(19, 31, 41, 42, 44, 60, 91, 100, 108, 109, 
                          110),
  time.optimize.ssr = 1951:1960,
  time.plot = 1951:1970)
...
plot(1951:1970, Y12, ylim=c(-10,10), type="l", xlab = "Year", ylab = "ESP Real GDP per capita Growth Rate")
lines(1951:1970, Y1synth2, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_IN_PLC2.png")
path.plot(synth.res = synth.out.plac2, dataprep.res = dataprep.out.plac2,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10, 10), Legend = c("Cuba",
...
dataprep.out.plac3 <-  dataprep(
  ...
  unit.names.variable = "countrycode",
  time.variable = "year",
  treatment.identifier = 108,
  controls.identifier = c(19, 31, 35, 41, 42, 44, 60, 91, 100, 109),
  time.optimize.ssr = 1951:1960,
  time.plot = 1951:1970)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_IN_PLC3.png")
path.plot(synth.res = synth.out.plac3, dataprep.res = dataprep.out.plac3,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-4, 8), Legend = c("Panama",
                                         "Synthetic Panama"), Legend.position = "bottomright")
dev.off()

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_IN_ALL.png")
plot(1951:1970, Y1, ylim=c(-9,18), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
...
legend("topright", legend = c("Trinidad and Tobago", "Brazil", "Cuba","Panama"),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/TTO_IN_DEN_10Y.png")
...
legend("topleft", legend = c("Trinidad and Tobago", "Brazil", 'Cuba','Panama'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/TTO_IN_DEN_5Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/TTO_IN_DEN_4Y.png")
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/TTO_IN_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.14), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
#lines(density(norm_datap4), col='orange', lty=2)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-Countries/Tese/Img/TTO_IN_DEN_2Y.png")
...
dbw <- db1[which(db1$country %in% trindad_c),]
...
plot(1951:1970, Y1w, ylim=c(-20,20), type="l", xlab = "Year", ylab = "Finland Real GDP per capita Growth Rate")
lines(1951:1970, Y1synthw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO.png")
...
plot(1951:1970, Y1placw, ylim=c(-10,10), type="l", xlab = "Year", ylab = "Italy Real GDP per capita Growth Rate")
lines( 1951:1970, Y1synthplacw, type="l", lty=2)

png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_PLC1.png")
path.plot(synth.res = synth.out.placw, dataprep.res = dataprep.out.placw,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-6, 10), Legend = c("Hungary",
                                        "Synthetic Hungary"), Legend.position = "bottomright")
dev.off
...
dataprep.out.plac2w <- dataprep(
  ...
  controls.identifier = c(2, 3, 19, 20, 23, 30, 
                          31, 35, 41, 42, 43, 44, 
                          60, 62, 65, 66, 
                          87, 91, 94, 95, 100, 101,
                          108, 109, 111, 112, 113, 122,
                          125, 129, 140,
                          154),
  time.optimize.ssr = 1951:1960,
  time.plot = 1951:1970)
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_PLC2.png")
path.plot(synth.res = synth.out.plac2w, dataprep.res = dataprep.out.plac2w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "year",
          Ylim = c(-4, 12), Legend = c("Peru",
                                        "Synthetic Peru"), Legend.position = "topright")
dev.off()
...
dataprep.out.plac3w <- dataprep(
  ...
  controls.identifier = c(2, 108, 19, 20, 23, 30, 
                          31, 35, 41, 42, 43, 44, 
                          60, 62, 65, 66, 
                          87, 91, 94, 95, 100, 101,
                          109, 111, 112, 113, 122,
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_PLC3.png")
path.plot(synth.res = synth.out.plac3w, dataprep.res = dataprep.out.plac3w,
          Ylab = "Real GDP per capita Growth Rate", Xlab = "Year",
          Ylim = c(-10, 20), Legend = c("Algeria",
                                        "Synthetic Algeria"), Legend.position = "bottomleftt")
dev.off()


png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_ALL.png")
plot(1951:1970, Y1w, ylim=c(-5,17), type="l", xlab = "Year", ylab = "Real GDP per capita Growth Rate", col="red",lwd=c(2))
...
legend("topright", legend = c("Trinidad and Tobago", "Hungary", "Peru", "Algeria"),
       col = c("red", "blue", "blue4", "blue3"), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(1960), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_DEN_10Y.png")
plot(density(norm_data),main = '10-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.15), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Trinidad and Tobago", "Hungary", "Peru", 'Algeria'),
       col = c("red", "blue", "green", 'pink'), lty = c(1,2,2,2), cex = 0.8)
abline(v=c(0), col=c("black"), lwd=c(2))
dev.off()
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_DEN_5Y.png")
plot(density(norm_data),main = '5-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.13), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Trinidad and Tobago", "Hungary", "Peru", 'Algeria'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_DEN_4Y.png")
plot(density(norm_data),main = '4-years ATE Density ',  col="red", xlim=c(-30,30), ylim=c(0, 0.11), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Trinidad and Tobago", "Hungary", "Peru", 'Algeria'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_DEN_3Y.png")
plot(density(norm_data),main = '3-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.11), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
legend("topleft", legend = c("Trinidad and Tobago", "Hungary", "Peru", 'Algeria'),
...
png(filename="C:/Users/paben/OneDrive/Ambiente de Trabalho/Tese/Final Data/Thesis/SCM-COUntries/Tese/Img/TTO_DEN_2Y.png")
plot(density(norm_data),main = '2-years ATE Density ',  col="red", xlim=c(-20,20), ylim=c(0, 0.13), lwd=c(2))
lines(density(norm_datap1), col='blue', lty=2)
lines(density(norm_datap2), col='green', lty=2)
lines(density(norm_datap3), col='pink', lty=2)
